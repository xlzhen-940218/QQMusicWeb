 ...
 public class SPHelper
 {
   ...
   public static void onSetPrefBoolSetting(String Tag, Boolean Value, Context activityContext) {
     if (Tag != null && Value != null && activityContext != null) {
       SharedPreferences settings = activityContext.getSharedPreferences("M3U8PreferenceHelper", 0);
       settings.edit().putBoolean(Tag, Value.booleanValue()).commit();
     }
   }
   ...
   public static Set<String> getStringSet(@NonNull String key, @Nullable Set<String> defValues) {
     ...
     return (result == null) ? null : Collections.<String>unmodifiableSet(result);
   }
...
/* Location:              C:\Users\Xiong\Desktop\m3u8.jar!\jaygoo\library\m3u8downloade\\utils\SPHelper.class
